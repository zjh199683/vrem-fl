...
class LocalOptimizer:
    ...
    def __init__(self,
        ...
        # TODO: how do we handle l^star in convergence proxy? Currently neglected
    ...
    def set_convergence_params(self, l1: float, l2: float) -> None:
        self.l1 = l1
        self.l2 = l2

    def set_optimization_params(self, rho1: float, rho2: float) -> None:
        self.rho1 = rho1
        self.rho2 = rho2

    def set_regularization_params(self, alpha: float, beta: float) -> None:
