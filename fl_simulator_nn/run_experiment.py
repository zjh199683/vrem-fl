...
if __name__ == "__main__":
    ...
    filename = '../TAXI_new_corr_datasetEstim_250.csv'
    ...
    print("Training..")
    pbar = tqdm(total=int((sim_len-args.min_time) / time_slot))
    lr_state_dict = None
    ...
    while time_now <= sim_len:
        ...
        for client in iter_clients:
            ...
            if tx_bits >= model_size:
                ...
                bandwidth_slots.append(bw_slots_client)
    ...
    with open('bw_slots_used_{}_{}.pkl'.format(args.selection_strategy, args.n_clients), 'wb') as f:
        pickle.dump(bandwidth_slots, f)
